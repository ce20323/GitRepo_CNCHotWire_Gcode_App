    ...
    methods
        ...
        function computeProfiles(app)
            ...
            if ~isempty(yLoopL)
                ...
                if app.isAnchorSyncStrategy()
                    ...
                    app.TxtProfileStatus.Value = {
                        sprintf('%s synchronisation failed.', ...
                        char(app.ProfileSyncStrategy));
                        char(failureMessage);
        ...
        function [yLS, zLS, yRS, zRS] = applyProfileSyncStrategy(app, yL, zL, yR, zR, stage)
            ...
            switch strategy
                ...
                case {"Notch Anchors", "Matched Corners"}
                    % Both anchor modes share cyclic section resampling.
                    % Keep the selected detection rule explicit so Matched
                    % Corners cannot silently fall back to notch detection.
                    switch stage
                        case "Initial"
    ...
    methods (Access = private)
        ...
        function createProfilesTab(app)
            ...
            app.ProfileSyncStrategyDropDown = uidropdown(gridSampling, ...
                ...
                'Matched Corners', 'Notch Anchors'}, ...
                'Value',char(app.ProfileSyncStrategy), ...
                'Enable', 'off', ...
                'FontSize',CNCHotWire_GCodeGenerator.FontSizeNormal, ...
                'Tooltip', ['Proportional Perimeter maps whole loops. ' ...
                'Matched Corners pairs all detected sharp corners. ' ...
                'Notch Anchors pairs one rectangular-notch pattern. ' ...
                'Both anchor modes require zero app kerf and coupled starts.'], ...
